	...
	public static void main(String[] args) {
		...
		jFrameConfig.getOkButton().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                AirportFrameBlockingQueue airportFrame = new AirportFrameBlockingQueue(ConfigBlockingQueue.nbPisteArr, ConfigBlockingQueue.nbPisteDep, ConfigBlockingQueue.nbPlace, ConfigBlockingQueue.nbAvion);
                jFrameConfig.setVisible(false);

                /**
                 * Version Blocking Queue
                 */
                BlockingQueue<AvionBlockingQueue> airArr = new ArrayBlockingQueue<AvionBlockingQueue>(ConfigBlockingQueue.nbAvion);
                BlockingQueue<AvionBlockingQueue> tarmacLand = new ArrayBlockingQueue<AvionBlockingQueue>(ConfigBlockingQueue.nbPisteArr);
                BlockingQueue<AvionBlockingQueue> tarmacTakeOff = new ArrayBlockingQueue<AvionBlockingQueue>(ConfigBlockingQueue.nbPisteDep);
                BlockingQueue<AvionBlockingQueue> terminal = new ArrayBlockingQueue<AvionBlockingQueue>(ConfigBlockingQueue.nbPlace);
                BlockingQueue<AvionBlockingQueue> airDep = new ArrayBlockingQueue<AvionBlockingQueue>(ConfigBlockingQueue.nbAvion);
                ...
                for (int i = 0; i < ConfigBlockingQueue.nbAvion; i++) {
                    AvionBlockingQueue avion = new AvionBlockingQueue(airportFrame, codePlane[i], airArr, tarmacLand, tarmacTakeOff, terminal, airDep,
                            ConfigBlockingQueue.nbAvion, ConfigBlockingQueue.nbPisteArr, ConfigBlockingQueue.nbPisteDep, ConfigBlockingQueue.nbPlace);
